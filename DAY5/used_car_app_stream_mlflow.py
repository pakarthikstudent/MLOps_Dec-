...
# MLflow Config
# -------------------------------
mlflow.set_experiment("Used_Car_Price_Experiment")
...
if uploaded_file is not None:
    ...
    with mlflow.start_run():
        ...
        # Log artifact - dataset preview
        preview_file = "dataset_preview.csv"
        df.head(50).to_csv(preview_file, index=False)
        mlflow.log_artifact(preview_file)
